// At the beginning of your existing processUserMessage function
function processUserMessage(userMessage) {
    showTypingIndicator();
    
    // Get the API URL based on the environment
    // When on Netlify, the API will be available at /api/chatbot
    // For local development, it depends on your setup
